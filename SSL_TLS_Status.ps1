...
@"
[
    {"hostname":"10.13.9.207","port":"443"},
    {"hostname":"10.13.9.206","port":"443"},
    {"hostname":"172.16.247.10","port":"10443"},
    {"hostname":"172.16.247.23","port":"443"}
]
"@ | convertfrom-json

foreach($server in $servers)
{
    Test-ServerSSLSupport $server.hostname $server.port >> D:\output.txt
}
